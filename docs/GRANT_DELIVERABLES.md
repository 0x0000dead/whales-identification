...
| 5 | Интерфейс и удобство использования | Минимизация кривой обучения | React + Tailwind UI, CLI, Swagger, Streamlit, Colab quickstart | `frontend/src/App.tsx`, `whales_identify/cli.py`, `docs/QUICKSTART_COLAB.ipynb`, `docs_fsie/Руководство_пользователя.md`. | ✓ |
