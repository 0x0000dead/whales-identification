...
### 1.1 Случайные числа в скрипте сравнения (заглушки заменены реальным расчётом)
...
**Обоснование:** имитационные значения недопустимы в сравнительных скриптах — все публикуемые метрики должны вычисляться на фиксированном тестовом срезе (`data/test_split/`).
