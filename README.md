...
7-дневное непрерывное тестирование доступности задокументировано в [reports/uptime_7day_summary.md](reports/uptime_7day_summary.md): 2 016 проверок раз в 5 минут с 23.03.2026 по 29.03.2026 UTC, средняя доступность 99.40 % (значительно выше целевых 95 %).
...
Веб-приложение доступно на `http://localhost:8080` после запуска стека или по публичному адресу [https://72.56.238.38.nip.io/](https://72.56.238.38.nip.io/).
...
![Главный экран — форма загрузки одиночного снимка](docs/screenshots/ui_upload.png)

![Результат идентификации горбатого кита](docs/screenshots/ui_detection_result.png)
...
![Карточка отклонения с объяснением и рекомендациями](docs/screenshots/ui_rejection.png)
...
![Пакетная обработка — статистика, гистограмма и таблица результатов](docs/screenshots/ui_batch_results.png)
